...
public class StudentServiceTests
{
    ...
    [Fact]
    public void GetStudentsByFaculty_WithNoStudents_ReturnsEmptyList()
    {
        var result = _service.GetStudentsByFaculty("Юридический");
        Assert.Empty(result);
    }
    ...
    [Fact]
    public void GetStudentsWithMinAverageGrade_WithHighThreshold_ReturnsBestStudent()
    {
        var result = _service.GetStudentsWithMinAverageGrade(4.9).ToList();
    ...
    [Fact]
    public void GetFacultyWithHighestAverageGrade_WithEqualAverages_ReturnsAnyTopFaculty()
    {
        var students = new List<Student>
        {
            new() { Name = "Иван", Faculty = "ФИТ", Grades = new List<int> { 5, 5, 5 } },
            new() { Name = "Анна", Faculty = "Экономика", Grades = new List<int> { 5, 5, 5 } }
        };
        var service = new StudentService(students);
        var result = service.GetFacultyWithHighestAverageGrade();
        
        Assert.True(result == "ФИТ" || result == "Экономика");
    }
}